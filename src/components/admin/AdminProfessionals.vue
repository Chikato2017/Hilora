    ...
    <div class="professional-component">
        ...
        <div class="verification-bar">
            <div class="verification-stages">
                ...
                <div class="pending">Pending Approval (2)</div>
                <div class="approved">Approved (4)</div>
                <div class="rejected">Rejected (3)</div>
            </div>
            <div class="line"></div>
        ...
        <div class="profiles">
            <div class="profile">
                <div class="details">
                    ...
                    <div class="name-and-others">
                        <div class="name">Chan Chin</div>
                        <div class="discipline-tag">
                            Senior Full Stack Engineer
                        </div>
                        <div class="location">
                            London, UK (Eligible UK/EU) • 7 yrs exp
                        </div>
                    </div>
                    <p class="status-p">
                        VISIBLE
                ...
                <div class="profile-btns">
                    <button class="inspect">Inspect Dosier</button>
                    <button class="approve approve-cmp">Verify Professional</button>
                </div>
            </div>
            <div class="profile">
                <div class="details">
            ...
            <div class="profile">
                <div class="details">
                    ...
                    <div class="name-and-others">
                        <div class="name">Christina Joe</div>
                        <div class="discipline-tag">
                            Senior Full Stack Engineer
                        </div>
                        <div class="location">
